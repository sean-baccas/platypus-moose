...
[Variables] 
  ...
  []
  [v_field] # Electric potential associated with source electric field
    type = MFEMComplexVariable
    fespace = H1FESpace
  []
[]
...
[BCs]
  ...
  [exterior_a_field]
    ...
    variable = a_field
    boundary = '${coil_in} ${coil_out} ${exterior} ${terminal_plane}'
  []
  [coil_input]
...
[Kernels]
  ...
  [conductive_mass_complex]
    ...
    [ImagComponent]
      type = MFEMVectorFEMassKernel
      coefficient = loss_coef_coil # = \omega * \sigma
      block = '${coil}'
    []
  []
  [source_current]
