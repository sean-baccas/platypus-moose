...
public:
  ...
  void SetConvention(const mfem::ComplexOperator::Convention & convention) { _conv = convention; }
  ...
  void FormRectangularSystemMatrix(const mfem::Array<int> & ess_trial_tdof_list,
                                   const mfem::Array<int> & ess_test_tdof_list,
                                   mfem::OperatorHandle & A);
